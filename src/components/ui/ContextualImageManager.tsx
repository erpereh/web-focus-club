...
export function ContextualImageManager({ currentUrl, defaultFolder, onSelect, onClose }: ContextualImageManagerProps) {
    ...
    return (
        ...
        >
            <motion.div
                className="glass-card w-full max-w-5xl h-[80vh] flex flex-col overflow-hidden relative"
            ...
            >
                ...
                <div className="flex-1 flex overflow-hidden">
                    ...
                    <div className="w-1/3 border-r border-border p-6 flex flex-col gap-6 bg-obsidian/30 overflow-y-auto">
