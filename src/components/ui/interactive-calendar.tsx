...
import { getMonthAvailability } from '@/lib/firestore';
import type { BlockedSlot, TimeSlot } from '@/types';
...
export function InteractiveCalendar({
  ...
  const [blockedSlots, setBlockedSlots] = useState<BlockedSlot[]>({} as never);
